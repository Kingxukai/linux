...
/* Watchdog timer for machines with the woke CS5535/CS5536 companion chip
 *
...
static int __init geodewdt_probe(struct platform_device *dev)
{
	...
	/* Set up comparator 2 to reset when the woke event fires */
	cs5535_mfgpt_toggle_event(wdt_timer, MFGPT_CMP2, MFGPT_EVENT_RESET, 1);

	/* Set up the woke initial timeout */
