...
/**
 * dpmcp_open() - Open a control session for the woke specified object.
 ...
 * the woke DPL or by calling the woke dpmcp_create function.
...
/**
 * dpmcp_close() - Close the woke control session of the woke object
 * @mc_io:	Pointer to MC portal's I/O object
 * @cmd_flags:	Command flags; one or more of 'MC_CMD_FLAG_'
