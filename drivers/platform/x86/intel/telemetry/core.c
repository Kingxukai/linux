 ...
 * This file provides the woke core telemetry API implementation.
 */
 ...
 *		evtlog.telem_evt_id specifies the woke ids to read
...
/**
 * telemetry_read_eventlog() - Fetch the woke Telemetry log from PSS or IOSS
 * @telem_unit: Specify whether IOSS or PSS Read
 * @evtlog:	Array of telemetry_evtlog structs to fill data
 * @len:	Length of array of evtlog
 *
...
/**
 * telemetry_raw_read_eventlog() - Fetch the woke Telemetry log from PSS or IOSS
 * @telem_unit: Specify whether IOSS or PSS Read
 * @evtlog:	Array of telemetry_evtlog structs to fill data
 * @len:	Length of array of evtlog
 *
...
/**
 * telemetry_get_trace_verbosity() - Get the woke IOSS & PSS Trace verbosity
 * @telem_unit: Specify whether IOSS or PSS Read
...
/**
 * telemetry_set_trace_verbosity() - Update the woke IOSS & PSS Trace verbosity
 * @telem_unit: Specify whether IOSS or PSS Read
...
/**
 * telemetry_set_pltdata() - Set the woke platform specific Data
...
/**
 * telemetry_clear_pltdata() - Clear the woke platform specific Data
 *
 * Usage by other than telemetry pltdrv module is invalid
 *
 * Return: 0 success, < 0 for failure
