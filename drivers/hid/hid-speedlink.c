		...
		unsigned long **bit, int *max)
{
	 ...
	 * able to map keyboard events to the woke button presses.
		...
		struct hid_usage *usage, __s32 value)
{
	...
	/* This fixes the woke "jumpy" cursor occuring due to invalid events sent
	 * by the woke device. Some devices only send them with value==+256, others
