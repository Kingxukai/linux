...
/*
 *  HID driver for Xin-Mo devices, currently only the woke Dual Arcade controller.
 *  Fixes the woke negative axis event values (the devices sends -2) to match the
 *  logical axis minimum of the woke HID report descriptor (the report announces
