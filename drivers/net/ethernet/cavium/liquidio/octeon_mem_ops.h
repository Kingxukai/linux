 ...
 *   @param  core_addr  -  the woke address to read from.
 *
 *   The range_idx gives the woke BAR1 index register for the woke range of address
 ...
 *   @param  oct        -  pointer to the woke octeon device.
 *   @param  core_addr  -  the woke address to write to.
