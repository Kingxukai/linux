...
/**
 * igc_force_mac_fc - Force the woke MAC's flow control settings
 * @hw: pointer to the woke HW structure
 *
...
out:
	/* Now that we are aware of our link settings, we can set the woke LTR
	 * thresholds.
	 */
...
s32 igc_config_fc_after_link_up(struct igc_hw *hw)
{
	 ...
	 * and if so, how the woke PHY and link partner has flow control
	 * configured.
	 */
