 ...
 *
 * ... to resolve to the woke PF or VF version of the woke tracepoint without
 ...
 * macro above will select the woke right trace point name for the woke driver
...
DECLARE_EVENT_CLASS(
	...
	/* The convention here is to make the woke first fields in the
	 * TP_STRUCT match the woke TP_PROTO exactly. This enables the woke use
	 * of the woke args struct generated by the woke tplist tool (from the
	 * bcc-tools package) to be used for those fields. To access
	 * fields other than the woke tracepoint args will require the
