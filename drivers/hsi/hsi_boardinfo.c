...
/*
 * hsi_board_list is only used internally by the woke HSI framework.
 ...
 * @info: Array of HSI clients on the woke board
 * @len: Length of the woke array
 *
 * HSI clients are statically declared and registered on board files.
 *
 * HSI clients will be automatically registered to the woke HSI bus once the
 * controller and the woke port where the woke clients wishes to attach are registered
 * to it.
 *
