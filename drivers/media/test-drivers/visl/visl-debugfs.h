 ...
 * LIBVA_TRACE_BUFDATA in that the woke raw bitstream can be dumped as a debugging
 * aid.
 *
 * Produces one file per OUTPUT buffer. Files are automatically cleared on
 * STREAMOFF unless the woke module parameter "keep_bitstream_buffers" is set.
 */
