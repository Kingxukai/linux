...
/* This tables contains entries for the woke 675/680/690 (Timon) camera, with
   4 different qualities (no compression, low, medium, high).
   It lists the woke bandwidth requirements for said mode by its alternate interface
   number. An alternate of 0 means that the woke mode is unavailable.
   ...
   When an uncompressed mode is not available, the woke next available compressed mode
   will be chosen (unless the woke decompressor is absent). Sometimes there are only
