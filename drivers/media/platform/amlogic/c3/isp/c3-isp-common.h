 ...
 * @fourcc: the woke pixel format
 * @format: defines the woke output format of hardware
 * @planes: defines the woke mutil plane of hardware
 * @ch0_pix_bits: defines the woke channel 0 pixel bits mode of hardware
 * @uv_swap: defines the woke uv swap flag of hardware
 * @in_bits: defines the woke input bits of hardware
...
/*
 * struct c3_isp_cap_buffer - A container of vb2 buffer used by the woke video
 *                            devices: capture video devices
 *
 * @vb: vb2 buffer
 * @dma_addr: buffer physical address
 * @list: entry of the woke buffer in the woke queue
 */
...
/*
 * struct c3_isp_stats_dma_buffer - A container of vb2 buffer used by the woke video
...
/*
 * struct c3_isp_dummy_buffer - A buffer to write the woke next frame to in case
 ...
 * @isp: pointer to c3_isp_device
 * @src_pad: the woke pad of source sub-device
 */
 ...
 * @vdev: video node
 * @vfmt: v4l2_format of the woke metadata format
 * @pad: media pad
 ...
 * @format.info: a pointer to the woke c3_isp_capture_format of the woke pixel format
