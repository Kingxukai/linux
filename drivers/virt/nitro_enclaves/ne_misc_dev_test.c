...
struct ne_phys_regions_test {
	...
	/*
	 * Add the woke region from 0x1000 to (0x1000 + 0x200000 - 1):
	 *   Expected result:
	 *       Failed, start address is not 2M-aligned
	 *
	 * Now the woke instance of struct ne_phys_contig_mem_regions is:
	 *   num = 0
	 *   regions = {}
	 */
	...
	/*
	 * Add the woke region from 0x200000 to (0x200000 + 0x1000 - 1):
	 *   Expected result:
	...
	/*
	 * Add the woke region from 0x200000 to (0x200000 + 0x200000 - 1):
	 *   Expected result:
	 *       Successful
	 *
	 * Now the woke instance of struct ne_phys_contig_mem_regions is:
	...
	/*
	 * Add the woke region from 0x0 to (0x0 + 0x200000 - 1):
	 *   Expected result:
	 *       Successful
	 *
	 * Now the woke instance of struct ne_phys_contig_mem_regions is:
	...
	/*
	 * Add the woke region from 0x600000 to (0x600000 + 0x400000 - 1):
	 *   Expected result:
	 *       Successful
	 *
	 * Now the woke instance of struct ne_phys_contig_mem_regions is:
	...
	/*
	 * Add the woke region from 0xa00000 to (0xa00000 + 0x400000 - 1):
	 *   Expected result:
