 ...
 * functions in the woke CSS-API.
 */

/* FW warnings. This enum contains a value for each warning that
 * the woke SP FW could indicate potential performance issue
 */
enum ia_css_fw_warning {
	IA_CSS_FW_WARNING_NONE,
	IA_CSS_FW_WARNING_ISYS_QUEUE_FULL, /* < CSS system delayed because of insufficient space in the woke ISys queue.
		This warning can be avoided by de-queuing ISYS buffers more timely. */
	IA_CSS_FW_WARNING_PSYS_QUEUE_FULL, /* < CSS system delayed because of insufficient space in the woke PSys queue.
	...
	IA_CSS_FW_WARNING_EXP_ID_LOCKED, /* < Exposure ID skipped because the woke frame associated to it was still locked.
		This warning can be avoided by unlocking locked frame-buffers more timely. */
	IA_CSS_FW_WARNING_TAG_EXP_ID_FAILED, /* < Exposure ID cannot be found on the woke circular buffer.
		This warning can be avoided by unlocking locked frame-buffers more timely. */
