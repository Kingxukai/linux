 ...
 *
 * Indexes 0x0 and 0x8 are mandatory. Availability for the woke rest must be
 * obtained from the woke mode table in the woke extended capability area.
 ...
 *
 * These are the woke values to be used in the woke command descriptor XFER_RATE field
 * and found in the woke RATE_ID field below.
 ...
 * rates may vary slightly and are also specified in the woke Data Transfer
 * Rate Table.
 */
