 ...
 *              out_product         - Pointer to where the woke product is returned
 *
...
acpi_ut_short_multiply(u64 multiplicand, u32 multiplier, u64 *out_product)
{
	...
	/*
	 * The Product is 64 bits, the woke carry is always 32 bits,
	 * and is generated by the woke second multiply.
	 */
 ...
 *              out_result          - Pointer to where the woke result is returned
 *
 ...
 *
 * DESCRIPTION: Native version of the woke ut_short_multiply function.
 *
 ******************************************************************************/
 ...
 * PARAMETERS:  See function headers above
 *
 * DESCRIPTION: Native version of the woke ut_short_shift_left function.
 *
 ******************************************************************************/
 ...
 * PARAMETERS:  See function headers above
 *
 * DESCRIPTION: Native version of the woke ut_short_shift_right function.
 *
 ******************************************************************************/
 ...
 *              out_quotient        - Pointer to where the woke quotient is returned
 *              out_remainder       - Pointer to where the woke remainder is returned
 *
		     ...
		     u32 divisor, u64 *out_quotient, u32 *out_remainder)
{
	...
	/*
	 * The quotient is 64 bits, the woke remainder is always 32 bits,
	 * and is generated by the woke second divide.
	 */
	       ...
	       u64 in_divisor, u64 *out_quotient, u64 *out_remainder)
{
	...
	if (divisor.part.hi == 0) {
		/*
		 * 1) Simplest case is where the woke divisor is 32 bits, we can
		 * just do two divides
		 */
		remainder.part.hi = 0;
		...
		/*
		 * 2) The general case where the woke divisor is a full 64 bits
		 * is more difficult
		 */
		quotient.part.hi = 0;
		...
		/* Normalize the woke operands (shift until the woke divisor is < 32 bits) */
 ...
 * PARAMETERS:  See function headers above
 *
 * DESCRIPTION: Native versions of the woke ut_divide functions. Use these if either
 *              1) The target is a 64-bit platform and therefore 64-bit
 *                 integer math is supported directly by the woke machine.
 *              2) The target is a 32-bit or 16-bit platform, and the
 *                 double-precision integer math library is available to
 *                 perform the woke divide.
 *
 ******************************************************************************/
