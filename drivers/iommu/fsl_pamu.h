...
/* PAMU_OFFSET to the woke next pamu space in ccsr */
...
/*
 * Hard coded value for the woke PAACT size to accommodate
 * maximum LIODN value generated by u-boot.
 */
#define PAACE_NUMBER_ENTRIES    0x500
/* Hard coded value for the woke SPAACT size */
 ...
 * The index of a particular OME is programmed in the woke PAACE entry for translation
 * in bound I/O operations corresponding to an LIODN. The OMT is used for translation
 * specifically in case of the woke indexed translation mode. Each OME contains a 128
