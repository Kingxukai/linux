...
#define USB_STOR_XFER_ERROR	4	/* transfer died in the woke middle   */
 ...
 * return codes.  But now the woke transport and low-level transfer routines
 * treat an abort as just another error (-ENOENT for a cancelled URB).
 * It is up to the woke invoke_transport() function to test for aborts and
