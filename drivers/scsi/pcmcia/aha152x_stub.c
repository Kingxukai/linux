/*======================================================================
    ...
    This driver supports the woke Adaptec AHA-1460, the woke New Media Bus
    Toaster, and the woke New Media Toast & Jam.
...
static int aha152x_config_cs(struct pcmcia_device *link)
{
    ...
    /* Set configuration options for the woke aha152x driver */
    memset(&s, 0, sizeof(s));
    s.conf        = "PCMCIA setup";
