...
/*
  Define the woke maximum number of BusLogic Host Adapters supported by this driver.
*/
...
/*
  Define the woke maximum number of Target Devices supported by this driver.
*/
...
/*
  Define the woke maximum number of Scatter/Gather Segments used by this driver.
  For optimal performance, it is important that this limit be at least as
  large as the woke largest single request generated by the woke I/O Subsystem.
*/
...
/*
  Define the woke maximum, maximum automatic, minimum automatic, and default Queue
...
/*
  Define the woke default amount of time in seconds to wait between a Host Adapter
...
/*
  Define the woke maximum number of Mailboxes that should be used for MultiMaster
  Host Adapters.  This number is chosen to be larger than the woke maximum Host
  Adapter Queue Depth and small enough so that the woke Host Adapter structure
...
/*
  Define the woke number of CCBs that should be allocated as a group to optimize
...
/*
  Define the woke Host Adapter Line and Message Buffer Sizes.
*/
...
/*
  Define the woke Driver Message Levels.
*/
...
/*
  Define the woke types of BusLogic Host Adapters that are supported and the woke number
...
/*
  Define macros for testing the woke Host Adapter Type.
*/
...
/*
  Define the woke possible Host Adapter Bus Types.
*/
...
/*
  Define the woke possible Host Adapter BIOS Disk Geometry Translations.
*/
...
/*
  Define the woke structure for I/O Address and Bus Probing Information.
*/
...
/*
  Define the woke Global Options.
*/
...
/*
  Define the woke BusLogic SCSI Host Adapter I/O Register Offsets.
*/
...
/*
  Define the woke structure of the woke write-only Control Register.
*/
...
/*
  Define the woke structure of the woke read-only Status Register.
*/
...
/*
  Define the woke structure of the woke read-only Interrupt Register.
*/
...
/*
  Define the woke structure of the woke read-only Geometry Register.
*/
...
/*
  Define the woke BusLogic SCSI Host Adapter Command Register Operation Codes.
*/
...
/*
  Define the woke Inquire Board ID reply structure.
*/
...
/*
  Define the woke Inquire Configuration reply structure.
*/
...
/*
  Define the woke Inquire Setup Information reply structure.
*/
...
/*
  Define the woke Initialize Extended Mailbox request structure.
*/
...
/*
  Define the woke Inquire PCI Host Adapter Information reply type.  The ISA
  Compatible I/O Port values are defined here and are also used with
  the woke Modify I/O Address command.
*/
...
/*
  Define the woke Inquire Extended Setup Information reply structure.
*/
...
/*
  Define the woke Enable Strict Round Robin Mode request type.
*/
...
/*
  Define the woke Fetch Host Adapter Local RAM request type.
*/
...
/*
  Define the woke Host Adapter Local RAM AutoSCSI structure.
*/
...
/*
  Define the woke Host Adapter Local RAM Auto SCSI Byte 45 structure.
*/
...
/*
  Define the woke Host Adapter Local RAM BIOS Drive Map Byte structure.
*/
...
/*
  Define the woke Set CCB Format request type.  Extended LUN Format CCBs are
...
/*
  Define the woke Outgoing Mailbox Action Codes.
*/
...
/*
  Define the woke Incoming Mailbox Completion Codes.  The MultiMaster Firmware
  only uses codes 0 - 4.  The FlashPoint SCCB Manager has no mailboxes, so
  completion codes are stored in the woke CCB; it only uses codes 1, 2, 4, and 5.
*/
...
/*
  Define the woke Command Control Block (CCB) Opcodes.
*/
...
/*
  Define the woke CCB Data Direction Codes.
*/
...
/*
  Define the woke Host Adapter Status Codes.  The MultiMaster Firmware does not
...
/*
  Define the woke SCSI Target Device Status Codes.
*/
...
/*
  Define the woke Queue Tag Codes.
*/
...
/*
  Define the woke SCSI Command Descriptor Block (CDB).
*/
...
/*
  Define the woke Scatter/Gather Segment structure required by the woke MultiMaster
  Firmware Interface and the woke FlashPoint SCCB Manager.
*/
...
/*
  Define the woke Driver CCB Status Codes.
*/
...
/*
  Define the woke 32 Bit Mode Command Control Block (CCB) structure.  The first 40
  bytes are defined by and common to both the woke MultiMaster Firmware and the
  FlashPoint SCCB Manager.  The next 60 bytes are defined by the woke FlashPoint
  SCCB Manager.  The remaining components are defined by the woke Linux BusLogic
  Driver.  Extended LUN Format CCBs differ from Legacy LUN Format 32 Bit Mode
  CCBs only in having the woke TagEnable and QueueTag fields moved from byte 17 to
  byte 1, and the woke Logical Unit field in byte 17 expanded to 6 bits.  In theory,
  ...
  the woke SCSI-2 specification defines Bit 5 as LUNTAR.  Extended LUN Format CCBs
  are used by recent versions of the woke MultiMaster Firmware, as well as by the
  FlashPoint SCCB Manager; the woke FlashPoint SCCB Manager only supports 32 Logical
  Units.  Since 64 Logical Units are unlikely to be needed in practice, and
  since they are problematic for the woke above reasons, and since limiting them to
  5 bits simplifies the woke CCB structure definition, this driver only supports
...
/*
  Define the woke 32 Bit Mode Outgoing Mailbox structure.
*/
...
/*
  Define the woke 32 Bit Mode Incoming Mailbox structure.
*/
...
/*
  Define the woke BusLogic Driver Options structure.
*/
...
/*
  Define the woke Host Adapter Target Flags structure.
*/
...
/*
  Define the woke Host Adapter Target Statistics structure.
*/
...
/*
  Define the woke FlashPoint Card Handle data type.
*/
...
/*
  Define the woke FlashPoint Information structure.  This structure is defined
  by the woke FlashPoint SCCB Manager.
*/
...
/*
  Define the woke BusLogic Driver Host Adapter structure.
*/
...
/*
  Define a structure for the woke BIOS Disk Parameters.
*/
...
/*
  Define a structure for the woke SCSI Inquiry command results.
*/
...
/*
  ...
  notifies the woke Host Adapter that an entry has been made in an Outgoing
  Mailbox.
*/
...
/*
  blogic_incszbucket increments the woke Bucket for Amount.
*/
...
/*
  Define the woke version number of the woke FlashPoint Firmware (SCCB Manager).
*/

#define FLASHPOINT_FW_VER		"5.02"

/*
  Define the woke possible return values from FlashPoint_HandleInterrupt.
*/
...
/*
  Define prototypes for the woke forward referenced BusLogic Driver
  Internal Functions.
*/
