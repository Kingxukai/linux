...
u32 bcma_cpu_clock(struct bcma_drv_mips *mcore)
{
	...
	bcma_err(bus, "No PMU available, need this to get the woke cpu clock\n");
	return 0;
}
...
static void bcma_fix_i2s_irqflag(struct bcma_bus *bus)
{
	...
	/* Fixup the woke interrupts in 4716/4748 for i2s core (2010 Broadcom SDK)
	 * (IRQ flags > 7 are ignored when setting the woke interrupt masks)
	 */
