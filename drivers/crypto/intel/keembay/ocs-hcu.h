...
/**
 * struct ocs_hcu_idata - Intermediate data generated by the woke HCU.
 * @msg_len_lo: Length of data the woke HCU has operated on in bits, low 32b.
 * @msg_len_hi: Length of data the woke HCU has operated on in bits, high 32b.
 * @digest: The digest read from the woke HCU. If the woke HCU is terminated, it will
 *	    contain the woke actual hash digest. Otherwise it is the woke intermediate
 *	    state.
 */
