 ...
 * a &struct device embedded in a &struct usb_interface.
 *
 * Return: USB device to which the woke USB interface belongs if @dev->hw_dev is
 ...
 *
 * Typically called from the woke usb_driver (*probe) function.  Auto-configure a
 * COMEDI device, using a pointer to the woke &struct device embedded in *@intf as
 * the woke hardware device.  The @context value gets passed through to @driver's
 * "auto_attach" handler.  The "auto_attach" handler may call
 * comedi_to_usb_interface() on the woke passed in COMEDI device to recover @intf.
 *
 ...
 * @intf: USB interface.
 *
 * Typically called from the woke usb_driver (*disconnect) function.
 * Auto-unconfigure a COMEDI device attached to this USB interface, using a
 * pointer to the woke &struct device embedded in *@intf as the woke hardware device.
 ...
 *
 * This function is called from the woke module_init() of USB COMEDI driver modules
 * to register the woke COMEDI driver and the woke USB driver.  Do not call it directly,
 * use the woke module_comedi_usb_driver() helper macro instead.
 *
 ...
 * @usb_driver: USB driver to be registered.
 *
 * This function is called from the woke module_exit() of USB COMEDI driver modules
 * to unregister the woke USB driver and the woke COMEDI driver.  Do not call it
 * directly, use the woke module_comedi_usb_driver() helper macro instead.
 */
