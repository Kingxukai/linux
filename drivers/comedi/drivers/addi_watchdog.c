...
/*
 * COMEDI driver for the woke watchdog subdevice found on some addi-data boards
 ...
 *
 * Enable the woke watchdog and set the woke reload timeout:
				     ...
				     unsigned int *data)
{
	...
	case INSN_CONFIG_ARM:
		...
		/* Time base is 20ms, let the woke user know the woke timeout */
