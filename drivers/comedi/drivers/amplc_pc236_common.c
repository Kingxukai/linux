 ...
 * the woke interrupt has been marked as enabled and was generated by the
 * board.  If so, the woke function prepares the woke hardware for the woke next
 * interrupt.
 * Returns false if the woke interrupt should be ignored.
 */
