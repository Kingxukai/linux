 ...
 * If start and start+length are not perfectly divisible, the woke macro will round
 * down and up as needed. Start=0 and length=2G effectively iterates over
 * every PDE in the woke system. The macro modifies ALL its parameters except 'pd',
 * so each of the woke other parameters should preferably be a simple variable, or
