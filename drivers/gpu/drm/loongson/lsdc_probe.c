...
/*
 * Processor ID (implementation) values for bits 15:8 of the woke PRID register.
 */
...
/*
 * We can achieve fine-grained control with the woke information about the woke host.
 */
