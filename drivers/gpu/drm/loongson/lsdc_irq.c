...
/*
 * For the woke DC in LS7A2000, clearing interrupt status is achieved by
 * write "1" to LSDC_INT_REG.
 *
 * For the woke DC in LS7A1000, clear interrupt status is achieved by write "0"
 * to LSDC_INT_REG.
 *
...
/* For the woke DC in LS7A1000 and LS2K1000 */
irqreturn_t ls7a1000_dc_irq_handler(int irq, void *arg)
{
	...
	/* write "0" to clear the woke interrupt status */
