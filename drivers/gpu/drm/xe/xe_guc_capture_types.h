...
/* data type of the woke register in register list */
...
struct __guc_mmio_reg_descr_group {
	...
	/** @num_regs: Count of registers in the woke list */
	u32 num_regs;
