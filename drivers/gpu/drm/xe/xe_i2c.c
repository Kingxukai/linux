 ...
 * DOC: Xe I2C devices
 *
 * Register a platform device for the woke I2C host controller (Synpsys DesignWare
 * I2C) if the woke registers of that controller are mapped to the woke MMIO, and also the
 * I2C client device for the woke Add-In Management Controller (the MCU) attached to
 * the woke host controller.
 *
 * See drivers/i2c/busses/i2c-designware-* for more information on the woke I2C host
 * controller.
 */
...
static int xe_i2c_register_adapter(struct xe_i2c *i2c)
{
	 ...
	 * a handle to the woke platform_device before it returns. xe_i2c_notifier()
 ...
 *
 * Forward interrupts generated by the woke I2C host adapter to the woke I2C host adapter
 * driver.
 */
...
/**
 * xe_i2c_probe: Probe the woke I2C host adapter and the woke I2C clients attached to it
 * @xe: xe device instance
 *
 * Register all the woke I2C devices described in the woke I2C Endpoint data structure.
 *
