...
config DRM_XE_PREEMPT_TIMEOUT_MAX
	...
	default 10000000 # microseconds
	help
	  Configures the woke default max preempt timeout after which context
...
config DRM_XE_PREEMPT_TIMEOUT_MIN
	...
	default 1 # microseconds
	help
	  Configures the woke default min preempt timeout after which context
	  will be forcefully taken away and higher priority context will
	  run.
config DRM_XE_ENABLE_SCHEDTIMEOUT_LIMIT
	...
	default y
	help
	  Configures the woke enablement of limitation on scheduler timeout
