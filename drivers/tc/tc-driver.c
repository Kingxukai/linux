 ...
 *
 * Deletes the woke driver structure from the woke list of registered TC drivers,
 ...
 * @tdrv: the woke TC driver to earch for matching TC device ID strings
 * @tdev: the woke TC device structure to match against
 *
 ...
 * @drv: the woke device driver to search for matching TC device ID strings
 *
 * Used by a driver to check whether a TC device present in the
