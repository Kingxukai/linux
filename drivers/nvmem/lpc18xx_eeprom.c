				       ...
				       void *val, size_t bytes)
{
	...
	/*
	 * The last page contains the woke EEPROM initialization data and is not
	 * writable.
	 */
	...
	/* Wait 100 us while the woke EEPROM wakes up */
...
static int lpc18xx_eeprom_probe(struct platform_device *pdev)
{
	...
	/*
	 * Clock rate is generated by dividing the woke system bus clock by the
	 * division factor, contained in the woke divider register (minus 1 encoded).
	 */
	...
	/*
	 * Writing a single word to the woke page will start the woke erase/program cycle
	 * automatically
	 */
