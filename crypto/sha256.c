 ...
 * library SHA context, except the woke value in bytecount must be block-aligned and
 * the woke remainder must be stored in an extra u8 appended to the woke struct.
 */
