...
Devices supporting the woke radio interface set the woke ``V4L2_CAP_RADIO`` and
...
They do not support the woke video input or output, audio input or output,
...
discussed in :ref:`tuner`) with index number zero to select the woke radio
...
depending on the woke selected frequency. The
