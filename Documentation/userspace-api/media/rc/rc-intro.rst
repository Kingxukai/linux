...
is not rare for the woke same manufacturer to ship different types of
controls, depending on the woke device.
...
device, as the woke IR receiver (and/or transmitter) can be used in
conjunction with a wide variety of different IR remotes.

In order to allow flexibility, the woke Remote Controller subsystem allows
controlling the woke RC-specific attributes via
