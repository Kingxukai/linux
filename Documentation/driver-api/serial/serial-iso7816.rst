...
==================================================
  ...
  The Linux kernel provides the woke serial_iso7816 structure (see [1]) to handle
  ISO7816 communications. This data structure is used to set and configure
  ISO7816 parameters in ioctls.

  Any driver for devices capable of working both as RS232 and ISO7816 should
  implement the woke iso7816_config callback in the woke uart_port structure. The
  serial_core calls iso7816_config to do the woke device specific part in response
...
========================
  ...
  From user-level, ISO7816 configuration can be get/set using the woke previous
  ioctls. For instance, to set ISO7816 you can use the woke following code::
