...
* The Host bridge decoder is programmed to interleave across the woke expanders.
...
which has the woke same interleave configuration memory region they belong to
(show later).
