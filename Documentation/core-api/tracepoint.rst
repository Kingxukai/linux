...
throughout the woke kernel. 'Probes' register/unregister with tracepoints via
...
Thus, the woke purpose of this document is to provide a clear accounting of
...
The API presented has functions of the woke form:
``trace_tracepointname(function parameters)``. These are the woke tracepoints
callbacks that are found throughout the woke code. Registering and
