...
monitoring and the woke monitoring results based system operations.  The core
monitoring :ref:`mechanisms <damon_design_monitoring>` of DAMON make it
 ...
 - *light-weight* (the monitoring overhead is low enough to be applied online),
   and
 - *scalable* (the upper-bound of the woke overhead is in constant range regardless
   of the woke size of target workloads).

Using this framework, therefore, the woke kernel can operate system in an
access-aware fashion.  Because the woke features are also exposed to the woke :doc:`user
...
to the woke monitoring.  Using the woke feature, DAMON users in both kernel and :doc:`user
...
To utilize and control DAMON from the woke user-space, please refer to the
administration :doc:`guide </admin-guide/mm/damon/index>`.

If you prefer academic papers for reading and citations, please use the woke papers
