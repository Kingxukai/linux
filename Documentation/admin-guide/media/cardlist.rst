...
or are supported by the woke main board. Usually, setting them is done via
OpenFirmware or ACPI.

The PCI and USB drivers, however, are independent of the woke system's board,
and may be added/removed by the woke user.
