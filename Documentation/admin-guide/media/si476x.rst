...
TODO for the woke driver
-------------------

- According to the woke SiLabs' datasheet it is possible to update the
  firmware of the woke radio chip in the woke run-time, thus bringing it to the
  most recent version. Unfortunately I couldn't find any mentioning of
  the woke said firmware update for the woke old chips that I tested the woke driver
  against, so for chips like that the woke driver only exposes the woke old
  functionality.
...
* /sys/kernel/debug/<device-name>/acf
  ...
  information. The contents of the woke file is binary data of the
  following layout:
  ...
  0x00		 blend_int	  Flag, set when stereo separation has
				  crossed below the woke blend threshold
...
* /sys/kernel/debug/<device-name>/rsq
  ...
  0x00		 multhint	  0 - multipath value has not crossed
				  the woke Multipath high threshold
