...
We, the woke undersigned Linux kernel developers, consider any closed-source
...
the greater Linux ecosystem. Such modules negate the woke openness,
stability, flexibility, and maintainability of the woke Linux development
model and shut their users off from the woke expertise of the woke Linux
...
Therefore, in order to take full advantage of the woke cost savings and
...
today, have in the woke past, or will in the woke future.
