...
refer to the woke Documentation/devicetree/bindings/hwmon/adi,adm1275.yaml for bindings
...
inX_label		"vin1" or "vout1" depending on chip variant and
			...
			vout1 reports the woke voltage on the woke VAUX pin.
...
curr1_lcrit		Critical minimum current. Depending on the woke chip
			configuration, either curr1_lcrit or curr1_crit is
			supported, but not both.
curr1_lcrit_alarm	Critical current low alarm.
curr1_crit		Critical maximum current. Depending on the woke chip
			configuration, either curr1_lcrit or curr1_crit is
			supported, but not both.
