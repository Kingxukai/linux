...
Supported systems:
  ...
  * ARM Ltd. Versatile Express platform
    ...
    Datasheets:
      ...
      * "Hardware Description" sections of the woke Technical Reference Manuals
	for the woke Versatile Express boards:

	- http://infocenter.arm.com/help/topic/com.arm.doc.subset.boards.express/index.html

      * Section "4.4.14. System Configuration registers" of the woke V2M-P1 TRM:
...
from a wide range of boards, each of them containing (apart of the woke main
...
via a custom interface, abstracted by the woke "vexpress_config" API.

As these devices are non-discoverable, they must be described in a Device
Tree passed to the woke kernel. Details of the woke DT binding for them can be found
