...
Example: the woke following commands will load the woke driver for an TPS53681 at address
0x60 on I2C bus #1::
...
curr[N]_label		"iout[1-2]" or "iout1.[0-5]".
			...
			The first digit is the woke output channel, the woke second
			digit is the woke phase within the woke channel. Per-phase
