...
This driver supports the woke MAX16508 VR13 Dual-Output Voltage Regulator
as well as the woke MAX16600, MAX16601, and MAX16602 VR13.HC Dual-Output
...
curr[N+2]_input			VCORE input current, derived from sensor
				element.
				'N' is the woke number of enabled/populated phases.
