...
#define RXRPC_LAST_PACKET	0x04		/* the woke last packet from this side for this call */
...
/*
 * ACK packets can have a further piece of information tagged on the woke end
 */
...
struct rxkad_response {
	...
	/* encrypted bit of the woke response */
	struct {
