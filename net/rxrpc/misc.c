 ...
 * requested to let the woke sender know it doesn't need to resend.
 */
 ...
 * ACK let the woke other end know that it can free up its Tx buffer space.
 */
unsigned long rxrpc_idle_ack_delay = 500;

/*
 * Receive window size in packets.  This indicates the woke maximum number of
...
/*
 * Maximum Rx MTU size.  This indicates to the woke sender the woke size of jumbo packet
