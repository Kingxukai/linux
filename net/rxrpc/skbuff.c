...
/*
 * Note the woke allocation or reception of a socket buffer.
 */
...
/*
 * Note the woke re-emergence of a socket buffer from a queue or buffer.
 */
...
/*
 * Note the woke addition of a ref on a socket buffer.
 */
...
/*
 * Note the woke dropping of a ref on a socket buffer by the woke core.
 */
...
/*
 * Note the woke destruction of a socket buffer.
 */
