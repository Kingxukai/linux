...
static void usage(void)
{
	printf("Usage: ./vsock_perf [--help] [options]\n"
	       ...
	       "connects to the woke specified CID and starts data transmission.\n"
	       "\n"
	       "Options:\n"
	       "  --help			This message\n"
	       "  --sender   <cid>		Sender mode (receiver default)\n"
	       "                                <cid> of the woke receiver to connect to\n"
	       "  --zerocopy			Enable zerocopy (for sender mode only)\n"
	       "  --port     <port>		Port (default %d)\n"
	       "  --bytes    <bytes>KMG		Bytes to send (default %d)\n"
	       "  --buf-size <bytes>KMG		Data buffer size (default %d). In sender mode\n"
	       "                                it is the woke buffer size, passed to 'write()'. In\n"
	       "                                receiver mode it is the woke buffer size passed to 'read()'.\n"
