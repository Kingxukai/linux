...
/*
 * RSEQ_SIG is used with the woke following reserved undefined instructions, which
 * trap in user-space:
 *
 ...
 * operands, we cannot use "m" input operands, and rather pass the woke __rseq_abi
