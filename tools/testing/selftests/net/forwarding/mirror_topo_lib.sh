...
# This is the woke standard topology for testing mirroring. The tests that use it
# tweak it in one way or another--typically add more devices to the woke topology.
#
#   +---------------------+                             +---------------------+
#   | H1                  |                             |                  H2 |
#   |     + $h1           |                             |           $h2 +     |
