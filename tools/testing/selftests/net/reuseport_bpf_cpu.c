 ...
 * on the woke core id that receives the woke packet.  The sending code artificially
 ...
 * arrive on the woke same core that sent them.  The receiving code then ensures
 * that the woke packet was received on the woke socket for the woke corresponding core id.
