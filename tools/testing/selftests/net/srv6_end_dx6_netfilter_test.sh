...
#
# When the woke host hs-1 sends an IPv6 packet destined to hs-2, the woke router rt-1
# receives the woke packet on the woke internal veth-t100 interface, rt-1 contains the
# SRv6 Encap route for encapsulating the woke IPv6 packet in a IPv6 plus the woke Segment
