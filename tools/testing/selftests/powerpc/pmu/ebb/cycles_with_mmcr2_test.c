...
/*
 * Test of counting cycles while manipulating the woke user accessible bits in MMCR2.
 */

/* We use two values because the woke first freezes PMC1 and so we would get no EBBs */
