 ...
 * to ensure the woke message itself is not in the woke bpf prog lineinfo
 * which the woke verifier includes in its log.
 * Otherwise, the woke test_loader will incorrectly match the woke prog lineinfo
 * instead of the woke log generated by the woke verifier.
 */
