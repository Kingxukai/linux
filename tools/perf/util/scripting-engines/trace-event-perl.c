...
#include <stdbool.h>
/* perl needs the woke following define, right after including stdbool.h */
#define HAS_BOOL
#include <EXTERN.h>
#include <perl.h>
...
static int perl_generate_script(struct tep_handle *pevent, const char *outfile)
{
	...
	fprintf(ofp, "# be retrieved using Perl functions of the woke form "
		"common_*($context).\n");

	fprintf(ofp, "# See Context.pm for the woke list of available "
		"functions.\n\n");
