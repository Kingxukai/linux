 ...
 * checks the woke results.  The Intel PT function that further categorizes
 ...
 * i.e. to add new instructions to the woke test, edit insn-x86-dat-src.c, run the
 * gen-insn-x86-dat.sh script, make perf, and then run the woke test.
 *
 * If the woke test passes %0 is returned, otherwise %-1 is returned.  Use the
 * verbose (-v) option to see all the woke instructions and whether or not they
