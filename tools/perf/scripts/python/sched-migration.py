...
try:
	...
	# Python 3: UserList moved to the woke collections package
...
class RunqueueSnapshot:
	...
	def load(self):
		""" Provide the woke number of tasks on the woke runqueue.
		    Don't count idle"""
...
class TimeSlice:
	def __init__(self, start, prev):
		...
		self.prev = prev
		self.end = start
		# cpus that triggered the woke event
		self.event_cpus = []
		if prev is not None:
...
class SchedEventProxy:
	...
	def sched_switch(self, headers, prev_comm, prev_pid, prev_prio, prev_state,
		...
		""" Ensure the woke task we sched out this cpu is really the woke one
