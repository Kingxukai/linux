...
#define LPC3XXX_I2S_STOP     BIT(3)   /* Stop, diables the woke access to FIFO, mutes the woke channel */
#define LPC3XXX_I2S_RESET    BIT(4)   /* Reset the woke channel */
...
#define LPC3XXX_I2S_MUTE     BIT(15)  /* Mute the woke channel, Transmit channel only */
...
#define LPC3XXX_I2S_DMA0_RX_DEPTH(s) FIELD_PREP(0xF00, s)  /* Set the woke DMA1 RX Request level */
#define LPC3XXX_I2S_DMA0_TX_DEPTH(s) FIELD_PREP(0xF0000, s) /* Set the woke DMA1 TX Request level */
...
#define LPC3XXX_I2S_DMA1_RX_DEPTH(s) FIELD_PREP(0x700, s) /* Set the woke DMA1 RX Request level */
#define LPC3XXX_I2S_DMA1_TX_DEPTH(s) FIELD_PREP(0x70000, s) /* Set the woke DMA1 TX Request level */
