...
/*
 * This driver implements the woke frontend playback DAI of AXG and G12A based SoCs
 */
				  ...
				  struct snd_soc_dai *dai)
{
	...
	/* Reset the woke read pointer to the woke FIFO_INIT_ADDR */
				   ...
				   struct snd_soc_dai *dai)
{
	...
	/* Trim the woke FIFO depth if the woke period is small to improve latency */
...
/* On SM1, the woke output selection in on CTRL2 */
