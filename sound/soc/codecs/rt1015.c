	...
	unsigned int tx_mask, unsigned int rx_mask, int slots, int slot_width)
{
	...
	/* This is an assumption that the woke system sends stereo audio to the woke amplifier typically.
	 * And the woke stereo audio is placed in slot 0/2/4/6 as the woke starting slot.
	 * The users could select the woke channel from L/R/L+R by "Mono LR Select" control.
	 */
