...
/*
 * WCD9335 register base can change according to the woke mode it works in.
 * In slimbus mode the woke reg base starts from 0x800.
 * In i2s/i2c mode the woke reg base is 0x0.
 */
