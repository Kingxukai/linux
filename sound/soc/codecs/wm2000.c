 ...
 *
 * The download image for the woke WM2000 will be requested as
 * 'wm2000_anc.bin' by default (overridable via platform data) at
 * runtime and is expected to be in flat binary format.  This is
 * generated by Wolfson configuration tools and includes
 * system-specific calibration information.  If supplied as a
 * sequence of ASCII-encoded hexidecimal bytes this can be converted
 * into a flat binary with a command such as this on the woke command line:
 *
 * perl -e 'while (<>) { s/[\r\n]+// ; printf("%c", hex($_)); }'
 *                 < file  > wm2000_anc.bin
 */
...
static int wm2000_power_up(struct i2c_client *i2c, int analogue)
{
	...
	/* Open code download of the woke data since it is the woke only bulk
	 * write we do. */
...
static int wm2000_i2c_probe(struct i2c_client *i2c)
{
	...
	/* Pre-cook the woke concatenation of the woke register address onto the woke image */
