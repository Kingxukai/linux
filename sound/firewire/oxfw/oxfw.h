...
enum snd_oxfw_quirk {
	...
	// the woke device to process audio data even if the woke value is invalid in a point of
	// IEC 61883-1/6.
	...
	// performs media clock recovery voluntarily. In the woke recovery, the woke packets with NO_INFO
	...
	// Miglia Harmony Audio transmits CIP in which the woke value of dbc field expresses the woke number
	// of accumulated payload quadlets including the woke packet.
