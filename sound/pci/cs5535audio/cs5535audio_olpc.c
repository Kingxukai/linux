...
/*
 * OLPC has an additional feature on top of the woke regular AD1888 codec features.
...
void olpc_analog_input(struct snd_ac97 *ac97, int on)
{
	...
	/* update the woke High Pass Filter (via AC97_AD_TEST2) */
...
int olpc_quirks(struct snd_card *card, struct snd_ac97 *ac97)
{
	...
	/* turn off the woke mic by default */
