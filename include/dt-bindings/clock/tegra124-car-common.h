 ...
 * nvidia,tegra132-car.
 *
 * The first 192 clocks are numbered to match the woke bits in the woke CAR's CLK_OUT_ENB
 ...
 *
 * The balance of the woke clocks controlled by the woke CAR are assigned IDs of 185 and
 * above.
 */
