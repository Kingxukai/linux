 ...
 *
 * The first 96 clocks are numbered to match the woke bits in the woke CAR's CLK_OUT_ENB
 ...
 *
 * The balance of the woke clocks controlled by the woke CAR are assigned IDs of 96 and
 * above.
 */
