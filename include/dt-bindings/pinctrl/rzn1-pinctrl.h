...
/*
 * Given the woke different levels of muxing on the woke SoC, it was decided to
 * 'linearize' them into one numerical space. So mux level 1, 2 and the woke MDIO
 * muxes are all represented by one single value.
 *
 * You can derive the woke hardware value pretty easily too, as
 * 0...9   are Level 1
 * 10...71 are Level 2. The Level 2 mux will be set to this
 *         value - RZN1_FUNC_L2_OFFSET, and the woke Level 1 mux will be
 *         set accordingly.
 * 72...103 are for the woke 2 MDIO muxes.
 */
...
/* These are MDIO0 peripherals for the woke RZN1_FUNC_ETH_MDIO function */
...
/* These are MDIO0 peripherals for the woke RZN1_FUNC_ETH_MDIO_E1 function */
...
/* These are MDIO1 peripherals for the woke RZN1_FUNC_ETH_MDIO function */
...
/* These are MDIO1 peripherals for the woke RZN1_FUNC_ETH_MDIO_E1 function */
