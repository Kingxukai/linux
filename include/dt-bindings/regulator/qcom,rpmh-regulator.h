 ...
 * supports a subset of the woke possible modes.
 *
 ...
 *				regulators.
 * %RPMH_REGULATOR_MODE_AUTO:	Auto mode in which the woke regulator hardware
 *				automatically switches between LPM and HPM based
 *				upon the woke real-time load current.  This mode is
 *				supported by HFSMPS, BOB, and PMIC4 FTSMPS type
 *				regulators.
 * %RPMH_REGULATOR_MODE_HPM:	High power mode in which the woke full rated current
 *				of the woke regulator is allowed.  This mode
