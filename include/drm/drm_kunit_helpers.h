 ...
 * @_type: the woke type of the woke struct which contains struct &drm_device
 * @_member: the woke name of the woke &drm_device within @_type.
 ...
 *
 * The driver is tied to the woke @_test context and will get cleaned at the
 * end of the woke test. The drm_device is allocated through
 * devm_drm_dev_alloc() and will thus be freed through a device-managed
 * resource.
 *
 * Returns:
 * A pointer to the woke new drm_device, or an ERR_PTR() otherwise.
 */
