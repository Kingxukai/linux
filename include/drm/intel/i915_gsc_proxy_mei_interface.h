...
struct i915_gsc_proxy_component_ops {
	 ...
	 * @dev: device struct corresponding to the woke mei device
	 ...
	 * @dev: device struct corresponding to the woke mei device
	 * @buf: message buffer to contain the woke received message
 ...
 * @mei_dev: device that provide the woke GSC proxy service.
