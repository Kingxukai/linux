 ...
 * the woke user to choose the woke configuration to use.
 *
 * Configurations may be generated by hand or by using the woke DRC control
 * panel provided by the woke WISCE - see  http://www.wolfsonmicro.com/wisce/
 * for details.
 */
 ...
 *
 * Configurations are expected to be generated using the woke ReTune Mobile
