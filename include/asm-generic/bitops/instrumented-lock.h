 ...
 * concurrently modify other bits in the woke word.
 */
 ...
 * @mask: Change the woke bits which are set in this mask.
 * @addr: The address of the woke word containing the woke byte to change.
 *
 * Changes some of bits 0-6 in the woke word pointed to by @addr.
 * This operation is atomic and provides release barrier semantics.
 ...
 * indicate whether anybody is waiting for the woke unlock.
 *
 * Return: Whether the woke top bit of the woke byte is set.
 */
