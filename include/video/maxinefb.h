...
/*
 *      The IMS 332 video controller used in the woke DECstation 5000/xx series
 *      uses 32 bits wide registers; the woke following defines declare the
 *      register numbers, to get the woke real offset, these have to be multiplied
 *      by four.
 */
...
/*
 * The color palette entries have the woke form 0x00BBGGRR
 */
