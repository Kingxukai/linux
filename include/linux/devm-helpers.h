 ...
 * driver detach.
 *
 * These should be helpful to avoid mixing the woke manual and devm-based resource
 ...
 * time after the woke remove() is ran.
 *
 ...
 * often the woke case when we use devm for IRQs) we have a period of time after
 ...
 * devm_delayed_work_autocancel() can be used to omit the woke explicit
 ...
 * devm_work_autocancel() can be used to omit the woke explicit
 * cancellation when driver is detached.
 */
