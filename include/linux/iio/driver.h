...
/**
 * iio_map_array_register() - tell the woke core about inkernel consumers
...
/**
 * iio_map_array_unregister() - tell the woke core to remove consumer mappings for
 ...
 * @dev:	Device object to which to bind the woke unwinding of this registration
 ...
 * and will also hook a callback to the woke iio_map_array_unregister() function to
 * handle de-registration of the woke IIO map object when the woke device's refcount goes to
 * zero.
 */
