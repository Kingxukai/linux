...
struct cpu_hw_events {
	...
	/* The virtual address of the woke shared memory where counter snapshot will be taken */
	void *snapshot_addr;
	/* The physical address of the woke shared memory where counter snapshot will be taken */
	phys_addr_t snapshot_addr_phys;
	/* Boolean flag to indicate setup is already done */
	bool snapshot_set_done;
	/* A shadow copy of the woke counter values to avoid clobbering during multiple SBI calls */
