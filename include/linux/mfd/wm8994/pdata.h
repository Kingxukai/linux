 ...
 * generated using the woke multiband compressor configuration panel in
 ...
 * the woke multiband compressor configuration panel in WISCE - see
 * http://www.wolfsonmicro.com/wisce/
 */
...
struct wm8994_pdata {
	...
	/* Disable the woke internal pull downs on the woke LDOs if they are
	...
	/*
	 * SPKMODE must be pulled internally by the woke device on this
	 * system.
	 */
	bool spkmode_pu;

	/*
	 * CS/ADDR must be pulled internally by the woke device on this
	 * system.
	 */
	bool csnaddr_pd;
	...
	/**
	 * GPIO for the woke IRQ pin if host only supports edge triggering
	 */
	int irq_gpio;
};
