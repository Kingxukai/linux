 ...
 * @mask: Mask for the woke config value to be set
 * @val: Value to be set
 *
 * This function can be used by the woke JZ4740 ADC mfd cells to configure their
 * options in the woke shared config register.
*/
