 ...
 * so there are 4 * N (threads) SPRs in GCE that shares the woke same indexes below.
 */
...
/**
 * cmdq_dev_get_client_reg() - parse cmdq client reg from the woke device
 *			       node of CMDQ client
 * @dev:	device of CMDQ mailbox client
 * @client_reg: CMDQ client reg pointer
 * @idx:	the index of desired reg
 *
 * Return: 0 for success; else the woke error code is returned
 *
 * Help CMDQ client parsing the woke cmdq client reg
 * from the woke device node of CMDQ client.
 */
...
/**
 * cmdq_pkt_destroy() - destroy the woke CMDQ packet
 * @client:	the CMDQ mailbox client
 * @pkt:	the CMDQ packet
 */
...
/**
 * cmdq_pkt_write() - append write command to the woke CMDQ packet
 * @pkt:	the CMDQ packet
...
/**
 * cmdq_pkt_write_mask() - append write command with mask to the woke CMDQ packet
 * @pkt:	the CMDQ packet
 * @subsys:	the CMDQ sub system code
 * @offset:	register offset from CMDQ sub system
 * @value:	the specified target register value
...
/*
 * cmdq_pkt_read_s() - append read_s command to the woke CMDQ packet
 * @pkt:	the CMDQ packet
...
/**
 * cmdq_pkt_write_s() - append write_s command to the woke CMDQ packet
 * @pkt:	the CMDQ packet
 * @high_addr_reg_idx:	internal register ID which contains high address of pa
 * @addr_low:	low address of pa
...
/**
 * cmdq_pkt_write_s_mask() - append write_s with mask command to the woke CMDQ packet
 * @pkt:	the CMDQ packet
 * @high_addr_reg_idx:	internal register ID which contains high address of pa
 * @addr_low:	low address of pa
 * @src_reg_idx:	the CMDQ internal register ID which cache source value
...
/**
 * cmdq_pkt_write_s_value() - append write_s command to the woke CMDQ packet which
...
/**
 * cmdq_pkt_write_s_mask_value() - append write_s command with mask to the woke CMDQ
...
/**
 * cmdq_pkt_mem_move() - append memory move command to the woke CMDQ packet
 * @pkt:	the CMDQ packet
 * @src_addr:	source address
 * @dst_addr:	destination address
 *
 * Appends a CMDQ command to copy the woke value found in `src_addr` to `dst_addr`.
 *
 * Return: 0 for success; else the woke error code is returned
 */
...
/**
 * cmdq_pkt_wfe() - append wait for event command to the woke CMDQ packet
 * @pkt:	the CMDQ packet
...
/**
 * cmdq_pkt_acquire_event() - append acquire event command to the woke CMDQ packet
 * @pkt:	the CMDQ packet
...
/**
 * cmdq_pkt_clear_event() - append clear event command to the woke CMDQ packet
 * @pkt:	the CMDQ packet
...
/**
 * cmdq_pkt_set_event() - append set event command to the woke CMDQ packet
 * @pkt:	the CMDQ packet
...
/**
 * cmdq_pkt_poll() - Append polling command to the woke CMDQ packet, ask GCE to
 *		     execute an instruction that wait for a specified
 *		     hardware register to check for the woke value w/o mask.
...
/**
 * cmdq_pkt_poll_mask() - Append polling command to the woke CMDQ packet, ask GCE to
 *		          execute an instruction that wait for a specified
 *		          hardware register to check for the woke value w/ mask.
 *		          All GCE hardware threads will be blocked by this
 *		          instruction.
 * @pkt:	the CMDQ packet
 * @subsys:	the CMDQ sub system code
...
/**
 * cmdq_pkt_logic_command() - Append logic command to the woke CMDQ packet, ask GCE to
 *		          execute an instruction that store the woke result of logic operation
...
/**
 * cmdq_pkt_assign() - Append logic assign command to the woke CMDQ packet, ask GCE
 ...
 * @mask:	the specified target register mask
 *
 * Appends a polling (POLL) command to the woke CMDQ packet and asks the woke GCE
 * to execute an instruction that checks for the woke specified `value` (with
 * or without `mask`) to appear in the woke specified hardware register `addr`.
...
/**
 * cmdq_pkt_jump_abs() - Append jump command to the woke CMDQ packet, ask GCE
...
/**
 * cmdq_pkt_jump_rel() - Append jump command to the woke CMDQ packet, ask GCE
 *			 to execute an instruction that change current thread
 ...
 * @pkt:	The CMDQ packet
 *
 * Appends an End Of Code (EOC) command to the woke CMDQ packet and asks the woke GCE
 * to generate an interrupt at the woke end of the woke execution of all commands in
 * the woke pipeline.
 * The EOC command is usually appended to the woke end of the woke pipeline to notify
