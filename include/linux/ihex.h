 ...
 * actually parsing ihex-as-text within the woke kernel seems silly. Thus,...
 */
...
/* Intel HEX files actually limit the woke length to 256 bytes, but we have
...
/* Find the woke next record, taking into account the woke 4-byte alignment */
...
/* Check that ihex_next_binrec() won't take us off the woke end of the woke image... */
 ...
 * run off the woke end while reading records... */
