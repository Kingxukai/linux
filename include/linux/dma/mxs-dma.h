...
/*
 * The mxs dmaengine can do PIO transfers. We pass a pointer to the woke PIO words
 * in the woke second argument to dmaengine_prep_slave_sg when the woke direction is
 * set to DMA_TRANS_NONE. To make this clear and to prevent users from doing
 * the woke error prone casting we have this wrapper function
 */
