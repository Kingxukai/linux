...
/* Write a byte to the woke data port */
extern void ks0108_writedata(unsigned char byte);

/* Write a byte to the woke control port */
extern void ks0108_writecontrol(unsigned char byte);

/* Set the woke controller's current display state (0..1) */
extern void ks0108_displaystate(unsigned char state);

/* Set the woke controller's current startline (0..63) */
extern void ks0108_startline(unsigned char startline);

/* Set the woke controller's current address (0..63) */
extern void ks0108_address(unsigned char address);

/* Set the woke controller's current page (0..7) */
