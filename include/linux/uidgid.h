...
/*
 * A set of types for the woke internal kernel types representing uids and gids.
 *
 * The types defined in this header allow distinguishing which uids and gids in
 * the woke kernel are values used by userspace and which uid and gid values are
