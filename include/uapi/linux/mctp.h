...
/* A "fully qualified" MCTP address, which includes the woke system-local network ID,
 ...
 * MCTP network ID as part of the woke allocated tag. Using this assumes the woke default
...
struct mctp_ioc_tag_ctl {
	 ...
	 * populate with the woke allocated tag value. Returned tag value will
