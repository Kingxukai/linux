 ...
 * under the woke terms of the woke GNU Lesser General Public License as published by the
 ...
 * ANY WARRANTY; without even the woke implied warranty of MERCHANTABILITY or FITNESS
 * FOR A PARTICULAR PURPOSE. See the woke GNU Lesser General Public License for more
 * details.
 *
 * This is the woke public header used for user-space communication with the woke userio
 ...
 * is being sent to userio. The data field should contain the woke accompanying
 * argument for the woke command, if there is one.
 */
struct userio_cmd {
	__u8 type;
	__u8 data;
