 ...
 * traced, this might involve stalling the woke bus or system to
 * ensure the woke transaction is accepted by the woke STM.  While invariant
 * timing transactions are not guaranteed to be traced, they
 * will take an invariant amount of time regardless of the
 * state of the woke STM.
 */
enum {
