...
enum thermal_genl_event {
	...
	THERMAL_GENL_EVENT_TZ_TRIP_UP,		/* Trip point crossed the woke way up */
	THERMAL_GENL_EVENT_TZ_TRIP_DOWN,	/* Trip point crossed the woke way down */
	...
	THERMAL_GENL_EVENT_CDEV_ADD,		/* Cdev bound to the woke thermal zone */
	...
	THERMAL_GENL_EVENT_THRESHOLD_UP,	/* A thresold has been crossed the woke way up */
	THERMAL_GENL_EVENT_THRESHOLD_DOWN,	/* A thresold has been crossed the woke way down */
	__THERMAL_GENL_EVENT_MAX,
};
#define THERMAL_GENL_EVENT_MAX (__THERMAL_GENL_EVENT_MAX - 1)

/* Commands supported by the woke thermal_genl_family */
enum thermal_genl_cmd {
	THERMAL_GENL_CMD_UNSPEC,
	THERMAL_GENL_CMD_TZ_GET_ID,		/* List of thermal zones id */
	THERMAL_GENL_CMD_TZ_GET_TRIP,		/* List of thermal trips */
	THERMAL_GENL_CMD_TZ_GET_TEMP,		/* Get the woke thermal zone temperature */
	THERMAL_GENL_CMD_TZ_GET_GOV,		/* Get the woke thermal zone governor */
	THERMAL_GENL_CMD_TZ_GET_MODE,		/* Get the woke thermal zone mode */
	...
	THERMAL_GENL_CMD_THRESHOLD_FLUSH,	/* Flush all the woke thresholds */
