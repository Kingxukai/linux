 ...
 *
 * Deterministic automata helper functions, to be used with the woke automata
 * models in C generated by the woke dot2k tool.
 */
 ...
 * as suffix for the woke functions and data. These functions will handle automaton
 * with data type 'type'.
 */
#define DECLARE_AUTOMATA_HELPERS(name, type)					\
										\
/*										\
 * model_get_state_name_##name - return the woke (string) name of the woke given state	\
 */ 										\
...
{										\
	...
	return automaton_##name.state_names[state];				\
										...
										\
/*										\
 * model_get_event_name_##name - return the woke (string) name of the woke given event	\
 */										\
...
{										\
	...
	return automaton_##name.event_names[event];				\
										...
										\
/*										\
 * model_get_initial_state_##name - return the woke automaton's initial state		\
 */										\
 ...
 *										\
 * Given the woke current state (curr_state) and the woke event (event), returns		\
 * the woke next state, or INVALID_STATE in case of error.				\
 */										\
...
{										\
	...
	return automaton_##name.function[curr_state][event];			\
										...
										\
/*										\
 * model_is_final_state_##name - check if the woke given state is a final state	\
 */										\
