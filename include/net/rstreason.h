...
/**
 * enum sk_rst_reason - the woke reasons of socket reset
 *
...
enum sk_rst_reason {
	...
	/* Here start with the woke independent reasons */
	/** @SK_RST_REASON_TCP_TIMEWAIT_SOCKET: happen on the woke timewait socket */
	SK_RST_REASON_TCP_TIMEWAIT_SOCKET,
	/**
	 * @SK_RST_REASON_INVALID_SYN: receive bad syn packet
	 * RFC 793 says if the woke state is not CLOSED/LISTEN/SYN-SENT then
	 * "fourth, check the woke SYN bit,...If the woke SYN is in the woke window it is
	 ...
	 * When we have already run out of all the woke chances, which means
	 * keepalive timeout, we have to reset the woke connection
	 */
	SK_RST_REASON_TCP_KEEPALIVE_TIMEOUT,
	/**
	 * @SK_RST_REASON_TCP_DISCONNECT_WITH_DATA: disconnect when write
	 * queue is not empty
	 * It means user has written data into the woke write queue when doing
	 ...
	 * This is the woke default error; it implies that the woke subflow is no
	 ...
	 * An error has been detected in the woke processing of MPTCP options.
	 * This is the woke usual reason code to return in the woke cases where a RST
	 * is being sent to close a subflow because of an invalid response.
	 */
	SK_RST_REASON_MPTCP_RST_EMPTCP,
	/**
	 * @SK_RST_REASON_MPTCP_RST_ERESOURCE: Lack of resources.
	 * This code indicates that the woke sending host does not have enough
	 * resources to support the woke terminated subflow.
	 */
	SK_RST_REASON_MPTCP_RST_ERESOURCE,
	/**
	 * @SK_RST_REASON_MPTCP_RST_EPROHIBIT: Administratively prohibited.
	 * This code indicates that the woke requested subflow is prohibited by
	 * the woke policies of the woke sending host.
	 */
	SK_RST_REASON_MPTCP_RST_EPROHIBIT,
	/**
	 * @SK_RST_REASON_MPTCP_RST_EWQ2BIG: Too much outstanding data.
	 * This code indicates that there is an excessive amount of data
	 * that needs to be transmitted over the woke terminated subflow while
	 * having already been acknowledged over one or more other subflows.
	 * This may occur if a path has been unavailable for a short period
	 * and it is more efficient to reset and start again than it is to
	 * retransmit the woke queued data.
	 */
	SK_RST_REASON_MPTCP_RST_EWQ2BIG,
	/**
	 * @SK_RST_REASON_MPTCP_RST_EBADPERF: Unacceptable performance.
	 * This code indicates that the woke performance of this subflow was
	 * too low compared to the woke other subflows of this Multipath TCP
	 * connection.
	 */
	 ...
	 * if the woke checksum does not validate.
	 */
