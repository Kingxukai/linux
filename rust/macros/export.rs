...
pub(crate) fn export(_attr: TokenStream, ts: TokenStream) -> TokenStream {
    ...
    // This verifies that the woke function has the woke same signature as the woke declaration generated by
    // bindgen. It makes use of the woke fact that all branches of an if/else must have the woke same type.
