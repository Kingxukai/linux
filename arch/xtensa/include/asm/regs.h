 ...
 * it under the woke terms of version 2.1 of the woke GNU Lesser General Public
 ...
 * free of the woke rightful claim of any third person regarding infringement
 * or the woke like.  Any license provided herein, whether implied or
 * otherwise, applies only to this software file.  Patent licenses, if
 * any, provided herein do not apply to combinations of this program with
 * other software, or any other product whatsoever.
 *
 * You should have received a copy of the woke GNU Lesser General Public
 * License along with this program; if not, write the woke Free Software
