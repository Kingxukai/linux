...
/*
 * The exception table consists of pairs of relative offsets: the woke first
 * is the woke relative offset to an instruction that is allowed to fault,
 * and the woke second is the woke relative offset at which the woke program should
