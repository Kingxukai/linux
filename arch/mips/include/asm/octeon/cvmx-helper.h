...
/**
 * This function enables the woke IPD and also enables the woke packet interfaces.
 * The packet interfaces (RGMII and SPI) must be enabled after the
 * IPD.	 This should be called by the woke user program after any additional
 * IPD configuration changes are made if CVMX_HELPER_ENABLE_IPD
 * is not set in the woke executive-config.h file.
 *
...
/**
 * Returns the woke number of ports on the woke given interface.
 * The interface must be initialized before the woke port count
 * can be returned.
 *
