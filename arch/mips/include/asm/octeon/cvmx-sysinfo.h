...
/*
 * This module provides system/board information obtained by the woke bootloader.
 */
 ...
 * __cvmx_app_init() populates this from the woke cvmx boot descriptor.
 ...
 * provided to set the woke required values in these cases.
 */
struct cvmx_sysinfo {
	 ...
	 * addresses, and it is up to the woke application to use the
	 * proper addressing mode (XKPHYS, KSEG0, etc.)
	 */
	uint64_t compact_flash_common_base_addr;
	uint64_t compact_flash_attribute_base_addr;
	/*
	 * Base address of the woke LED display (as on EBT3000 board) This
	 * will be 0 if LED display not present.  Note that this
	 * address is a physical address, and it is up to the
	 * application to use the woke proper addressing mode (XKPHYS,
	 * KSEG0, etc.)
	 */
...
/**
 * This function returns the woke system/board information as obtained
 * by the woke bootloader.
 *
 *
 * Returns  Pointer to the woke boot information structure
 *
 */
