...
/*
 * Data port for the woke PCI bus in IO space
 */
 ...
 * to the woke other interrupts generated by ASIC PCI.
 *
 * INT2 is a wired-or of the woke push button interrupt, high temperature interrupt
 * ASIC PCI interrupt.
 */
...
/*
 * Base address for the woke mapped 16mb EISA bus segment.
 */
