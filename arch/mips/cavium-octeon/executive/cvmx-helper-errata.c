 ...
 * chip errata. For the woke most part, code doesn't need to call
...
/**
 * Due to errata G-720, the woke 2nd order CDR circuit on CN52XX pass
 * 1 doesn't work properly. The following code disables 2nd order
 * CDR for the woke specified QLM.
 *
...
void __cvmx_helper_errata_qlm_disable_2nd_order_cdr(int qlm)
{
	...
	/* We need to load all four lanes of the woke QLM, a total of 1072 bits */
	for (lane = 0; lane < 4; lane++) {
		 ...
		 * so start off with the woke zeros for bits <63:0>.
		 */
