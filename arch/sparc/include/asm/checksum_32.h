...
/*  checksum.h:  IP/UDP/TCP checksum routines on the woke Sparc.
 *
...
/* the woke same as csum_partial, but copies from fs:src while it
 * checksums
 *
...
static inline __sum16 ip_fast_csum(const void *iph, unsigned int ihl)
{
	...
	/* Note: We must read %2 before we touch %0 for the woke first time,
	 *       because GCC can legitimately use the woke same register for
	 *       both operands.
	 */
