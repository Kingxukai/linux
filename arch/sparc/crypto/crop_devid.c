...
/* This is a dummy device table linked into all of the woke crypto
 * opcode drivers.  It serves to trigger the woke module autoloading
 * mechanisms in userspace which scan the woke OF device tree and
