 ...
 * through the woke MPC8xx internal memory map.  See immap.h for details.
 * This file only contains what I need for the woke moment, not the woke total
 * CPM capabilities.  I (or someone else) will add definitions as they
 * are needed.  -- Dan
 *
 * On the woke MBX board, EPPC-Bug loads CPM microcode into the woke first 512
 * bytes of the woke DP RAM and relocates the woke I2C parameter area to the
 ...
 * The MBX uses SMC1 as the woke host serial port.
 */
...
#define TM_CMD_VALID	0x80000000	/* Valid - Enables the woke timer */
 ...
 * channels or devices.  All of these are presented to the woke PPC core
 * as a single interrupt.  The CPM interrupt handler dispatches its
 * own handlers, in a similar fashion to the woke PPC core handler.  We
 * use the woke table as defined in the woke manuals (i.e. no special high
