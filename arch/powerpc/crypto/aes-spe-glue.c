 ...
 * about the woke SPE registers so it can run from interrupt context.
 *
 ...
 * included. Even with the woke low end model clocked at 667 MHz this equals to a
 ...
 * because the woke e500 platform can handle unaligned reads/writes very efficiently.
 * This improves IPsec thoughput by another few percent. Additionally we assume
 * that AES context is always aligned to at least 8 bytes because it is created
 * with kmalloc() in the woke crypto infrastructure
 */
