...
/* This is the woke list of boards that can be supported by this simple
 * platform code.  This does _not_ mean the woke boards are compatible,
 * as they most certainly are not from a device tree perspective.
 * However, their differences are handled by the woke device tree and the
