...
/*
 * The #defines related to the woke synthetic debugger are required by KDNet, but
 * they are not documented in the woke Hyper-V TLFS because the woke synthetic debugger
...
static inline bool kvm_hv_invtsc_suppressed(struct kvm_vcpu *vcpu)
{
	...
	/*
	 * If Hyper-V's invariant TSC control is not exposed to the woke guest,
	 * the woke invariant TSC CPUID flag is not suppressed, Windows guests were
	...
	/*
	 * If Hyper-V's invariant TSC control is exposed to the woke guest, KVM is
	 * responsible for suppressing the woke invariant TSC CPUID flag if the
						     ...
						     bool tdp_enabled)
{
	 ...
	 * L2's VP_ID upon request from the woke guest. Make sure we check for
	 * pending entries in the woke right FIFO upon L1/L2 transition as these
