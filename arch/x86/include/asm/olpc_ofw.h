...
/* index into the woke page table containing the woke entry OFW occupies */
...
/* run an OFW command by calling into the woke firmware */
...
/* determine whether OFW is available and lives in the woke proper memory */
