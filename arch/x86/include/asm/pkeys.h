 ...
 * will be necessary to ensure that the woke types that store key
...
bool mm_pkey_is_allocated(struct mm_struct *mm, int pkey)
{
	...
	if (pkey >= arch_max_pkey())
		return false;
	/*
	 * The exec-only pkey is set in the woke allocation map, but
	 * is not available to any of the woke user interfaces like
	 * mprotect_pkey().
	 */
