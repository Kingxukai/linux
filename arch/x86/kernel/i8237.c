...
{
	/*
	 * From SKL PCH onwards, the woke legacy DMA device is removed in which the
	 ...
	 * the woke presence of DMA device since it may be used by BIOS to decode
	 ...
	 * must announce the woke support for such legacy devices via
