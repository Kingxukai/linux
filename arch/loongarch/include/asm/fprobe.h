 ...
 * have enough number of fixed MSBs of the woke address of kernel objects for
 * encoding the woke size of data in fprobe_header. Use 2-entries encoding instead.
 */
