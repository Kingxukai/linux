...
# This script locates the woke start of the woke .data section in xipImage and
...
# Make sure data occupies the woke last part of the woke file.
...
# substitute the woke data section by a compressed version
