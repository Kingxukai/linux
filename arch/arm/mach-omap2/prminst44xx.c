...
/**
 * omap_prm_base_init - Populates the woke prm partitions
 *
 * Populates the woke base addresses of the woke _prm_bases
...
/**
 * omap4_prminst_is_hardreset_asserted - read the woke HW reset line state of
...
/**
 * omap4_prminst_assert_hardreset - assert the woke HW reset line of a submodule
 * @rstctrl_reg: RM_RSTCTRL register address for this module
 ...
 * @st_shift: status bit offset corresponding to the woke reset line
 * @part: PRM partition
