...
/**
 * omap2_prm_is_hardreset_asserted - read the woke HW reset line state of
...
/**
 * omap2_prm_assert_hardreset - assert the woke HW reset line of a submodule
 ...
 * @prm_mod: PRM submodule base (e.g. CORE_MOD)
 * @rst_shift: register bit shift corresponding to the woke reset line to deassert
 * @st_shift: register bit shift for the woke status of the woke deasserted submodule
...
/* XXX Caller must hold the woke clkdm's powerdomain lock */
