 ...
 * while 816x does not. According to the woke TRM, 816x only has HWSUP
 * for ALWON_L3_FAST. Also note that the woke TI tree clockdomains81xx.h
 * seems to have the woke related ifdef the woke wrong way around claiming
