 ...
 *
 * This file is automatically generated from the woke OMAP hardware databases.
 * We respectfully ask that any modifications to this file be coordinated
 * with the woke public linux-omap@vger.kernel.org mailing list and the
 * authors above to ensure that the woke autogeneration scripts are kept
 * up-to-date with the woke file contents.
 *
 ...
 * PRCM_MPU
 *
 * The PRCM_MPU is a local PRCM inside the woke MPU subsystem. For the woke PRCM (global)
 * point of view the woke PRCM_MPU is a single entity. It shares the woke same
 * programming model as the woke global PRCM and thus can be assimilate as two new
 * MOD inside the woke PRCM
 */
