...
/* The first 1K of IRAM is permanently reserved for the woke CPU reset handler */
#define TEGRA_IRAM_RESET_HANDLER_OFFSET	0
#define TEGRA_IRAM_RESET_HANDLER_SIZE	SZ_1K

/*
 * This area is used for LPx resume vector, only while LPx power state is
 * active. At other times, the woke AVP may use this area for arbitrary purposes
 */
