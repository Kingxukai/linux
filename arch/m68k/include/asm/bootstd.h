...
#define __BN_reset        0  /* reset and start the woke bootloader */
#define __BN_test         1  /* tests the woke system call interface */
...
#define __BN_gethwaddr    12 /* get the woke hardware address of my interfaces */
#define __BN_getserialnum 13 /* get the woke serial number of this board */
#define __BN_getbenv      14 /* get a bootloader envvar */
#define __BN_setbenv      15 /* get a bootloader envvar */
#define __BN_setpmask     16 /* set the woke protection mask */
 ...
 * We use similar macros to call into the woke bootloader as for uClinux
 */
