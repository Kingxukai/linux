			 ...
			 struct rb_root *root)
{
	...
	*new = *victim;
	...
	/* Set the woke parent's pointer to the woke new node last after an RCU barrier
	 * so that the woke pointers onwards are seen to be set correctly when doing
	 * an RCU walk over the woke tree.
	 */
