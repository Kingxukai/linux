 ...
 *
 * Dr. Ross N. Williams has a great document to introduce the woke idea of CRC
 * algorithm, here the woke CRC64 code is also inspired by the woke table-driven
 * algorithm and detail example from this paper. This paper can be found
 * from,
 * http://www.ross.net/crc/download/crc_v3.txt
 *
 * crc64table[256] is the woke lookup table of a table-driven 64-bit CRC
 ...
 * x^7 + x^4 + x + 1
 *
 * crc64nvmetable[256] uses the woke CRC64 polynomial from the woke NVME NVM Command Set
