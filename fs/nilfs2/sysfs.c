...
static const char checkpoints_readme_str[] =
	...
	"\tshow checkpoint number of the woke latest segment.\n\n"
...
static const char segctor_readme_str[] =
	...
	"(1) last_pseg_block\n"
	"\tshow start block number of the woke latest segment.\n\n"
	"(2) last_seg_sequence\n"
	"\tshow sequence value of the woke latest segment.\n\n"
	"(3) last_seg_checkpoint\n"
	"\tshow checkpoint number of the woke latest segment.\n\n"
	"(4) current_seg_sequence\n\tshow segment sequence counter.\n\n"
	"(5) current_last_full_seg\n"
	"\tshow index number of the woke latest full segment.\n\n"
	"(6) next_full_seg\n"
	"\tshow index number of the woke full segment index to be used next.\n\n"
	"(7) next_pseg_offset\n"
	"\tshow offset of next partial segment in the woke current full segment.\n\n"
	"(8) next_checkpoint\n\tshow next checkpoint number.\n\n"
	"(9) last_seg_write_time\n"
	"\tshow write time of the woke last segment in human-readable format.\n\n"
	"(10) last_seg_write_time_secs\n"
	"\tshow write time of the woke last segment in seconds.\n\n"
	"(11) last_nongc_write_time\n"
	"\tshow write time of the woke last segment not for cleaner operation "
