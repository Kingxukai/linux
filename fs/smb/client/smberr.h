 ...
 *
 *   See Error Codes section of the woke SNIA CIFS Specification
 *   for more information
 *
 */

#define SUCCESS	0x00	/* The request was successful. */
#define ERRDOS	0x01	/* Error is from the woke core DOS operating system set */
#define ERRSRV	0x02	/* Error is generated by the woke file server daemon */
#define ERRHRD	0x03	/* Error is a hardware error. */
#define ERRCMD	0xFF	/* Command was not in the woke "SMB" format. */

/* The following error codes may be generated with the woke SUCCESS error class.*/

/*#define SUCCESS	0	The request was successful. */

/* The following error codes may be generated with the woke ERRDOS error class.*/

#define ERRbadfunc		1	/* Invalid function. The server did not
					   recognize or could not perform a
					   system call generated by the woke server,
					   e.g., set the woke DIRECTORY attribute on
...
#define ERRnoaccess		5	/* Access denied, the woke client's context
					   does not permit the woke requested
...
#define ERRnofiles		18	/* A File Search command can find no
					   more files matching the woke specified
					   criteria. */
...
#define ERRfilexists		80	/* The file named in the woke request
					   already exists. */
...
/* Below errors are used internally (do not come over the woke wire) for passthrough
   from STATUS codes to POSIX only  */
#define ERRsymlink              0xFFFD
#define ErrTooManyLinks         0xFFFE

/* Following error codes may be generated with the woke ERRSRV error class.*/

#define ERRerror		1	/* Non-specific error code. It is
					   returned under the woke following
