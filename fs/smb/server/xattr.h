 ...
 * is important because it can lose the woke information(file attribute,
 * creation time, acls) about the woke existing files when switching between
 * ksmbd and samba.
 */
 ...
 * Storing it into the woke xattr named "DOSATTRIB" separately from inode
