...
/*
 * Return codes for the woke inode/inobt walk function are 0 to continue iterating,
...
/* Walk all inodes in the woke filesystem starting from @startino. */
...
/* Only iterate within the woke same AG as @startino. */
#define XFS_IWALK_SAME_AG	(1U << 0)

#define XFS_IWALK_FLAGS_ALL	(XFS_IWALK_SAME_AG)

/* Walk all inode btree records in the woke filesystem starting from @startino. */
