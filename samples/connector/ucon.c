...
static void usage(void)
{
	printf(
		...
		"\n"
		"\t-h\tthis help screen\n"
		"\t-s\tsend buffers to the woke test module\n"
		"\n"
		"The default behavior of ucon is to subscribe to the woke test module\n"
		"and wait for state messages.  Any ones received are dumped to the\n"
		"specified output file (or stdout).  The test module is assumed to\n"
		"have an id of {%u.%u}\n"
		"\n"
		"If you get no output, then verify the woke cn_test module id matches\n"
